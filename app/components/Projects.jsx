  ...
  return (
    ...
    scroll-mt-20'>
      ...
      <motion.div
        ...
        {projectData.map(({ icon, title, bgImage, description, link,link2 }, index) => (
          <motion.div
            whileHover={{ scale: 1.05 }}



            key={index} className='border border-gray-400 rounded-lg text-white px-6 py-6 hover:bg-[#fcf4ff] hover:-translate-y-1 hover:shadow-2xl
            ...
            <div className='flex items-center gap-5 '>
              <a href={link} className='flex items-center justify-center gap-2  text-white  text-sm mt-5  '>
                Live Demos <Image src={assets.right_arrow} alt='' className='w-4 ' />
              </a>
              <a href={link2} className='flex items-center justify-center gap-2  text-white  text-sm mt-5  w-28 '>
                Github <Image src={assets.right_arrow} alt='' className='w-4 ' />
              </a>
            </div>
          </motion.div>
        ))}
